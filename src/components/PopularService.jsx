                    ...
                    >
                            ...
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between px-10 items-center">
                                    <div className="p-4 mb-8 md:w-1/2  md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Move to New Home with Nest</h1>
                                        ...
                                        <Link to='/s' className='bg-red-600 text-white font-semibold px-6 py-3 rounded-md mb-4'>Explore More</Link>
                                    </div>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex   justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row-reverse justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Nest team will help you to rearrange your furniture</h1>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Our special interior designer team at your service</h1>
                                        ...
                                        <Link to='/service' className='bg-red-600 text-white font-semibold px-6 py-3 rounded-md mb-4 '>Explore More</Link>
                                    </div>
                                    <div className="md:w-1/2">
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex   justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row-reverse justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Hire professional cleaners from NEST</h1>
