                    ...
                    >
                            ...
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between px-10 items-center">
                                    <div className="p-4 mb-8 md:w-1/2  md:px-20">
                                        <h1 className="text-2xl md:text-4xl font-bold  mb-4 text-sky-700">Move to New Home with Nest</h1>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex   justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row-reverse justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-2xl md:text-4xl font-bold  mb-4 text-sky-700">Nest team will help you to rearrange your furniture</h1>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-2xl md:text-4xl font-bold  mb-4 text-sky-700">Our special interior designer team at your service</h1>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex   justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row-reverse justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-2xl md:text-4xl font-bold  mb-4 text-sky-700">Hire professional cleaners from NEST</h1>
