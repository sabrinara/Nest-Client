...
const NavBar = ({ toggleTheme }) => {
    ...
    return (
        <div className="sticky inset-0 z-10  dark:text-sky-500 block h-max w-full max-w-full rounded-none border border-white/80  bg-opacity-40 py-2 px-4  shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
