...
const AboutUs = () => {
    return (
        <div className=" lg:px-40 lg:py-20">
            ...
            <div className="card card-side bg-white text-cyan-900  shadow-xl mb-8 h-[46vh] lg:h-[80vh]">
                <figure className="w-2/3">
                    <img src={"https://i.ibb.co/3WP2xvR/heavy-box.png"}  />
                </figure>
                <div className="card-body">
                    <h2 className="card-title mt-10 lg:mt-40 lg:text-2xl lg:font-bold text-blue-800">Heavy Furniture Moving!</h2>
            ...
            <div className="card card-side bg-white text-cyan-900  shadow-xl mb-8 h-[46vh] lg:h-[80vh]">
                ...
                <div className="card-body lg:mx-10 ">
                    <h2 className="card-title mt-10 lg:mt-40 lg:text-3xl lg:font-bold text-blue-800">Any type of shifting!</h2>
            ...
            <div className="card card-side bg-white text-cyan-900 shadow-xl h-[46vh] lg:h-[80vh] ">
                <figure className="w-2/3">
                    <img src={"https://i.ibb.co/GVR7vNX/moving.png"}  />
                </figure>
                <div className="card-body lg:mr-8">
                    <h2 className="card-title mt-10 lg:mt-36 lg:text-3xl lg:font-bold  text-blue-800">Also helping with packing!</h2>
